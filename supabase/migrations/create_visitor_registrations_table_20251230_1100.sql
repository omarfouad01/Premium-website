...
CREATE POLICY IF NOT EXISTS "Allow public insert to visitor registrations" ON visitor_registrations_premium_20251225
  FOR INSERT WITH CHECK (true);

CREATE POLICY IF NOT EXISTS "Allow authenticated users full access to visitor registrations" ON visitor_registrations_premium_20251225
